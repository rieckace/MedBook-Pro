    ...
    <form onSubmit={onSubmitHandler} className="m-5 w-full">
      ...
      <div className="bg-white px-8 py-8 border-0 rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll">
        ...
        <div>
          ...
          <textarea onChange={(e)=>setAbout(e.target.value)} value={about} className="w-full px-4 pt-2 border border-gray-200" placeholder="write about doctor" rows={5} required />
        </div>
