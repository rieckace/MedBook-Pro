...
import RelDoctors from "../components/RelDoctors";
  ...
  return (
    docInfo && (
      <div>
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <div className="flex-1 border border-gray-400 rounded-lg p-8 py-7 bg-white mx-2 sm:mx-0 mt-[-80px] sm:mt-0">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 max0w-[700px] mt-1">
                {docInfo.about}
              </p>
            </div>
        ...
        {/**Listing relaeted doc */}
        <RelDoctors docId={docId} speciality={docInfo.speciality} />
      </div>
    )
  );
};
